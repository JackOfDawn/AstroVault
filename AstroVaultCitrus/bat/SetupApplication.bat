...
:: Android packaging
set AND_CERT_NAME="AstroVault"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\AstroVault.p12
...
set IOS_PROVISION=cert\AstroVault.mobileprovision
...
set APP_ID=air.AstroVault

:: Output packages
set DIST_PATH=dist
set DIST_NAME=AstroVault
